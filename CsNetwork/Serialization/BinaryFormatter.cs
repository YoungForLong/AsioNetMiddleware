namespace CsNetwork.Serialization
{
#pragma warning disable 0675, 0618
    ...
    public unsafe static partial class BinaryFormatter
    {
        ...
        {
            if (clazz.IsEnum)
                clazz = Enum.GetUnderlyingType(clazz);
    ...
    public static partial class BinaryFormatter
    {
        public static Encoding DefaultEncoding { get { return m_strEncoding; } set { m_strEncoding = value; } }

        private static object LongToValue(Type type, long value)
        {
            Type clazz = type;
            if (clazz.IsEnum)
                type = Enum.GetUnderlyingType(clazz);
            object result = null;
            if (type == typeof(int))
